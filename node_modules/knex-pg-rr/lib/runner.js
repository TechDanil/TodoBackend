...
(0, _assign3.default)(Runner.prototype, {
  ...
  run: function run() {
    ...
    var isRead = sql.method === 'select' || sql.method === 'first';
    return _bluebird2.default.using(this.ensureConnection(isRead), function (connection) {
  ...
  ensureConnection: function ensureConnection(isRead) {
    var _this2 = this;
    ...
    return _bluebird2.default.try(function () {
      return _this2.connection || new _bluebird2.default(function (resolver, rejecter) {
        ...
        return _this2.client.acquireConnection(isRead).then(resolver).catch(_bluebird2.default.TimeoutError, function (error) {
          if (_this2.builder) {
      ...
      // need to return promise or null from handler to prevent warning from bluebird
      return _this2.client.releaseConnection(_this2.connection, isRead);
    });
  }
});
